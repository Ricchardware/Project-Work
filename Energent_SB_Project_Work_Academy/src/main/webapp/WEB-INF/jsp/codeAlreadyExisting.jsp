...
<link href="../../webjars/bootstrap/4.0.0/css/bootstrap.min.css"
	rel="stylesheet" />
<link href="${pageContext.request.contextPath}/css/codeConflict.css"
...
<body style="background-color: #333333">
	<font color="white"><br> <br>
		<div class="container">
			<h1>
				<center>Conflict identified: this code already exists!</center>
			...
			<table class="table table-hover"
				...
				<tbody>
					<tr>
						<td><c:out value="${academy.code}" /></td>
						<td><c:out value="${academy.title}" /></td>
						<td><c:out value="${academy.location}" /></td>
						<td><c:out value="${academy.startDate}" /></td>
						<td><c:out value="${academy.endDate}" /></td>
						<td><center>
						...
						<td><center>
								...
								<a type="button" class="btn btn-danger btn-lg btn3d"
			...
			<a type=button class="btn3d btn btn-white btn-lg" href="${homeURL}"
				role="button"> <svg xmlns="http://www.w3.org/2000/svg"
					width="24" height="24" fill="currentColor" class="bi bi-house-fill"
					viewBox="0 0 16 16">
  			<path fill-rule="evenodd"
